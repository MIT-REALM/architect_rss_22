...
def run_optimizer():
    ...
    state_trace, total_effort = sat_design_problem.simulator(sat_design_problem.design_params.get_values(), exogenous_sample)
    ...
    rob_ax.plot(robustness.t, robustness.x)
    rob_ax.set_xlabel("t")
